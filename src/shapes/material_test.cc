...
TEST(MaterialTest, EyeBetweenLightAndSurface) {
  ...
  Tuple eye_vector = TupleFromVector(0.0, 0.0, -1.0);
  Tuple normal_vector = TupleFromVector(0.0, 0.0, -1.0);
  PointLight light = PointLight(TupleFromPoint(0.0, 0.0, -10.0), Color(1.0, 1.0, 1.0));
...
TEST(MaterialTest, EyeOffset45BetweenLightAndSurface) {
  ...
  Tuple eye_vector = TupleFromPoint(0.0, sqrt(2.0) / 2.0, -sqrt(2.0) / 2.0);
  Tuple normal_vector = TupleFromVector(0.0, 0.0, -1.0);
  PointLight light = PointLight(TupleFromPoint(0.0, 0.0, -10.0), Color(1.0, 1.0, 1.0));
...
TEST(MaterialTest, LightOffset45EyeOppositeSurface) {
  ...
  Tuple eye_vector = TupleFromVector(0.0, 0.0, -1.0);
  Tuple normal_vector = TupleFromVector(0.0, 0.0, -1.0);
  PointLight light = PointLight(TupleFromPoint(0.0, 10.0, -10.0), Color(1.0, 1.0, 1.0));
...
TEST(MaterialTest, LightingInReflectionPathOfEye) {
  ...
  Tuple eye_vector = TupleFromVector(0.0, -sqrt(2.0) / 2.0, -sqrt(2.0) / 2.0);
  Tuple normal_vector = TupleFromVector(0.0, 0.0, -1.0);
  PointLight light = PointLight(TupleFromPoint(0.0, 10.0, -10.0), Color(1.0, 1.0, 1.0));
...
TEST(MaterialTest, LightBehindSurface) {
  ...
  Tuple eye_vector = TupleFromPoint(0.0, 0.0, -1.0);
  Tuple normal_vector = TupleFromVector(0.0, 0.0, -1.0);
  PointLight light = PointLight(TupleFromPoint(0.0, 0.0, 10.0), Color(1.0, 1.0, 1.0));
